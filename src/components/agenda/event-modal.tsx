            ...
            <div className="flex items-center gap-3">
              ...
              {event?.leadId && onOpenLeadInCrm && (
                <button
                  ...
                  className="flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold cursor-pointer active:scale-95 transition-all duration-200 text-white shadow-[0_0_16px_rgba(37,211,102,0.3)] hover:shadow-[0_0_24px_rgba(37,211,102,0.5)]"
